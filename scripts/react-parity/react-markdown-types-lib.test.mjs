...
import { buildTypeInventory } from './react-markdown-types-lib.mjs';
...
async function fixture() {
	...
	await cp(
		new URL('../../packages/react-markdown/audit/type-probes', import.meta.url),
		upstreamRoot,
		{ recursive: true },
	);
	await cp(new URL('../../packages/react-markdown/typetests', import.meta.url), adaptedRoot, {
		recursive: true,
	});
