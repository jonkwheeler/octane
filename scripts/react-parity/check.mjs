...
import { verifyReactPdfTestClassifications } from './react-pdf-classifications-lib.mjs';
...
try {
	verifyReactPdfTestClassifications(REPO);
} catch (error) {
	errors.push(`react-pdf test classifications are invalid: ${error.message}`);
}
