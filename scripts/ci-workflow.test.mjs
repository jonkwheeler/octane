...
describe('CI workflow aggregation', () => {
	...
	test('keeps cheap parity validation universal and full execution on Node 24', () => {
		...
		// recorded-unverified still runs required lanes: verification gates
		// full-suite provenance schema, not CI execution of declared evidence.
		assert.match(reactParityCheck, /const action = 'run-required'/);
		assert.match(
			reactParityCheck,
