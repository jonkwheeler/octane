...
`,
	...
	console.log(
		'installed packed Octane, Hook Form, Apollo Client, Syntax Highlighter, and Three without React; typecheck, Vite client/server builds, root/deep subpaths, singleton runtime, and executed binding SSR passed',
	);
}
...
function validatePackedTsrxConsumer(tempRoot, archives) {
	...
	console.log(
		'strict tsrx-tsc validated the packed binding source consumer with the installed Octane Volar compiler and precise public props',
	);
}
