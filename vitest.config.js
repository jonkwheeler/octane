	...
	test: {
		...
		projects: [
			...
			},
			{
				test: {
					name: 'mantine-store',
					include: ['packages/mantine-store/tests/conformance/**/*.test.ts'],
					environment: 'jsdom',
					globals: false,
				},
				plugins: [octane()],
				resolve: {
					alias: [
						{
							find: /^@octanejs\/mantine-store$/,
							replacement: resolve(import.meta.dirname, 'packages/mantine-store/src/index.ts'),
						},
					],
				},
			},
			{
				test: {
					...
					include: ['packages/mantine-notifications/tests/conformance/**/*.test.ts'],
					environment: 'jsdom',
					globals: false,
				},
				plugins: [octane()],
				resolve: {
					alias: [
						{
							find: /^@octanejs\/mantine-notifications$/,
							replacement: resolve(import.meta.dirname, 'packages/mantine-notifications/src/index.ts'),
						},
						{
							find: /^@octanejs\/mantine-store$/,
							replacement: resolve(import.meta.dirname, 'packages/mantine-store/src/index.ts'),
			...
			},
			{
				test: {
					...
					include: ['packages/mantine-spotlight/tests/conformance/**/*.test.ts'],
					environment: 'jsdom',
					globals: false,
				},
				plugins: [octane()],
				resolve: {
					alias: [
						{
							find: /^@octanejs\/mantine-spotlight$/,
							replacement: resolve(import.meta.dirname, 'packages/mantine-spotlight/src/index.ts'),
						},
						{
							find: /^@octanejs\/mantine-store$/,
							replacement: resolve(import.meta.dirname, 'packages/mantine-store/src/index.ts'),
			...
			},
			{
				test: {
					...
					include: ['packages/mantine-nprogress/tests/conformance/**/*.test.ts'],
					environment: 'jsdom',
					globals: false,
				},
				plugins: [octane()],
				resolve: {
					alias: [
						{
							find: /^@octanejs\/mantine-nprogress$/,
							replacement: resolve(import.meta.dirname, 'packages/mantine-nprogress/src/index.ts'),
						},
						{
							find: /^@octanejs\/mantine-store$/,
							replacement: resolve(import.meta.dirname, 'packages/mantine-store/src/index.ts'),
			...
			},
			{
				test: {
					name: 'mantine-modals',
					include: ['packages/mantine-modals/tests/conformance/**/*.test.ts'],
					environment: 'jsdom',
					globals: false,
				},
				plugins: [octane()],
				resolve: {
					alias: [
						{
							find: /^@octanejs\/mantine-modals$/,
							replacement: resolve(import.meta.dirname, 'packages/mantine-modals/src/index.ts'),
						},
						{
							find: /^@octanejs\/mantine-core$/,
							replacement: resolve(import.meta.dirname, 'packages/mantine-core/src/index.ts'),
			...
			},
			{
				test: {
					...
					include: ['packages/mantine-carousel/tests/conformance/**/*.test.ts'],
					environment: 'jsdom',
					globals: false,
				},
				plugins: [octane()],
				resolve: {
					alias: [
						{
							find: /^@octanejs\/mantine-carousel$/,
							replacement: resolve(import.meta.dirname, 'packages/mantine-carousel/src/index.ts'),
						},
						{
							find: /^@octanejs\/mantine-core$/,
							replacement: resolve(import.meta.dirname, 'packages/mantine-core/src/index.ts'),
			...
			},
			{
				test: {
					...
					include: ['packages/mantine-dropzone/tests/conformance/**/*.test.ts'],
					environment: 'jsdom',
					globals: false,
				},
				plugins: [octane()],
				resolve: {
					alias: [
						{
							find: /^@octanejs\/mantine-dropzone$/,
							replacement: resolve(import.meta.dirname, 'packages/mantine-dropzone/src/index.ts'),
						},
						{
							find: /^@octanejs\/mantine-core$/,
							replacement: resolve(import.meta.dirname, 'packages/mantine-core/src/index.ts'),
			...
			},
			{
				...
				resolve: {
					alias: [
						{
							find: /^@octanejs\/mantine-tiptap$/,
							replacement: resolve(import.meta.dirname, 'packages/mantine-tiptap/src/index.ts'),
						},
						{
