...
export default defineConfig({
	test: {
		...
		projects: [
			...
			{
				// Octane-only export conformance + port regressions. No React /
				// upstream suite runs here — do not claim react-parity ownership.
				// A future differential lane needs its own isolated project,
				// exact include, globalSetup, and packages/blocknote/audit/react-parity.json.
				test: {
					name: 'blocknote',
