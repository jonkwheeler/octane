...
- Octane's ref-as-prop model removes the upstream forwardRef detection branch and does not throw ensureRefIsUsedByChild when a custom child omits a ref.
