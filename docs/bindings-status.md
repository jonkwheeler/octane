...
| [`@octanejs/react-resizable-panels`](#octanejsreact-resizable-panels) | `react-resizable-panels@4.12.2` | Group, Panel, Separator, persistence hooks, refs, imperative APIs, layout constraints, pointer and keyboard interaction, ARIA, cursor handling, and ResizeObserver behavior are implemented against react-resizable-panels 4.12.2. | none known | Deterministic server rendering and live hydration adoption are covered by dedicated executable projects. | 2026-08-02 |
...
## @octanejs/react-resizable-panels

[`packages/react-resizable-panels`](../packages/react-resizable-panels) `0.1.0` — ports `react-resizable-panels@4.12.2`. Status data: [`packages/react-resizable-panels/status.json`](../packages/react-resizable-panels/status.json).
