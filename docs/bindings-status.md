...
- The bounded React parity manifest pins the official release tag and commit, classifies every local runtime test, and executes required adapted-upstream, differential, and adapted-type lanes. Provenance remains recorded-unverified because pristine repository-suite lanes are still open follow-up work.
