...
- The bounded React parity manifest pins the official release tag and commit, classifies every local runtime test, and executes required differential, adaptation, SSR, and type lanes. Provenance remains recorded-unverified because the npm artifact omits the canonical upstream test suite.
