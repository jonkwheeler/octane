...
## @octanejs/react-dropzone

[`packages/react-dropzone`](../packages/react-dropzone) `0.1.20` — ports `react-dropzone@20.0.0`. Status data: [`packages/react-dropzone/status.json`](../packages/react-dropzone/status.json).
...
- Consumers import from @octanejs/react-dropzone and author TSRX instead of importing react-dropzone and authoring React JSX; option names and observable file-acquisition behavior remain mapped to the pinned upstream contract.
