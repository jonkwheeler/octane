...
[`packages/react-textarea-autosize`](../packages/react-textarea-autosize) `0.1.0` — ports `react-textarea-autosize@8.5.9`. Status data: [`packages/react-textarea-autosize/status.json`](../packages/react-textarea-autosize/status.json).
...
See also: [`packages/react-textarea-autosize/README.md`](../packages/react-textarea-autosize/README.md), [`packages/react-textarea-autosize/UPSTREAM.md`](../packages/react-textarea-autosize/UPSTREAM.md)
