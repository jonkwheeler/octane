...
Ship `@octanejs/react-pdf` as an exact Octane binding for the published
...
1. Add a publishable `packages/react-pdf` package with pinned license,
...
- U1 complete: `pnpm --dir packages/react-pdf test:feasibility` passes 5 files and
