/**
 * Adapted parity evidence for native event semantics that intentionally differ
 * from React Testing Library's synthetic remapping. Ordinary fireEvent commit
 * timing stays in `events.test.ts` so ordinary CI keeps those cases.
 */
...
describe('native event semantics (intentional divergence from React)', () => {
	...
	// OCTANE DIVERGENCE[testing-library-native-events][adapted:testing-library-native-change]
	// @parity-case adapted:testing-library-native-change
	...
	// OCTANE DIVERGENCE[testing-library-native-events][adapted:testing-library-native-input]
	// @parity-case adapted:testing-library-native-input
	...
	// OCTANE DIVERGENCE[testing-library-native-events][adapted:testing-library-native-checkbox-change]
	// @parity-case adapted:testing-library-native-checkbox-change
	...
	// OCTANE DIVERGENCE[testing-library-native-events][adapted:testing-library-native-mouse-enter]
	// @parity-case adapted:testing-library-native-mouse-enter
