...
import type { ComboboxProps, ComboboxStylesNames } from './Combobox.tsrx';
import type { OptionsFilter } from './OptionsDropdown/OptionsDropdown.tsrx';
...
export interface ComboboxItemGroup<T, Group extends OctaneNode = OctaneNode> {
  group: Group;
  items: T[];
}
