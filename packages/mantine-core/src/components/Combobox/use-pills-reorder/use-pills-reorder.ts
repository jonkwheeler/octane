...
export interface PillReorderProps {
  ...
  onMouseDown: (event: OctaneMouseEvent<HTMLElement>) => void;
  onDragStart: (event: OctaneDragEvent<HTMLElement>) => void;
  onDragOver: (event: OctaneDragEvent<HTMLElement>) => void;
  onDragLeave: (event: OctaneDragEvent<HTMLElement>) => void;
  onDrop: (event: OctaneDragEvent<HTMLElement>) => void;
  onDragEnd: (event: OctaneDragEvent<HTMLElement>) => void;
  onKeyDown: (event: OctaneKeyboardEvent<HTMLElement>) => void;
}
...
export function usePillsReorder<T>({ value, onChange, enabled }: UsePillsReorderInput<T>) {
  ...
  const handleInputKeyDown = (event: OctaneKeyboardEvent<HTMLInputElement>) => {
