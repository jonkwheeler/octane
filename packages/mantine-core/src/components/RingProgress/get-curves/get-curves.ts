...
type NativeCircleProps = MantineIntrinsicProps<'circle'>;
import type { OctaneNode } from 'octane';
import type { DataAttributes, MantineColor } from '../../../core';

interface CurveData extends NativeCircleProps, DataAttributes {
  value: number;
  color: MantineColor;
  tooltip?: OctaneNode;
}

interface RootCurveData extends NativeCircleProps, DataAttributes {
  value?: never;
  color?: MantineColor;
}
