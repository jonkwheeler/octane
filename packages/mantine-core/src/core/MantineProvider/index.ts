...
export { MantineProvider, HeadlessMantineProvider } from './MantineProvider.tsrx';
export {
  MantineContext,
  useMantineContext,
...
export type { MantineProviderProps, HeadlessMantineProviderProps } from './MantineProvider.tsrx';
