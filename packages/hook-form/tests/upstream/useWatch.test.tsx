...
describe('useWatch', () => {
	...
	// OCTANE DIVERGENCE[hook-form-native-noop-input]: upstream fires an input event whose value equals the current value
	...
	describe('update', () => {
		// OCTANE DIVERGENCE[hook-form-microtask-batching]: after handleSubmit, RHF emits two state notifications in SEPARATE
		...
		// OCTANE DIVERGENCE[hook-form-microtask-batching]: same microtask-flush behavior as 'should partial re-render' above —
	...
	describe('compute ', () => {
		// OCTANE DIVERGENCE[hook-form-eager-equal-bailout]: on the first input ('' → '12') compute yields `false`, equal to the
