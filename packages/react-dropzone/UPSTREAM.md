...
`@octanejs/react-dropzone` is pinned to `react-dropzone@20.0.0`, canonical commit
...
The exhaustive export and upstream-test disposition crosswalk is completed in U5.
