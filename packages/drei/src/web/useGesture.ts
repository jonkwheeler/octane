...
import { dragAction, hoverAction, moveAction, pinchAction, registerAction, scrollAction, wheelAction } from '@use-gesture/core/actions';
...
for (const action of [dragAction, pinchAction, scrollAction, wheelAction, moveAction, hoverAction]) registerAction(action);
