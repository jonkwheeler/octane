...
const props: ViewProps = { as: 'section', visible: true, index: 2, frames: 1, className: 'preview' };
const viewport: ViewportProps = View;
const container: ContainerProps = { visible: true, scene: new THREE.Scene(), index: 1, frames: Infinity,
	rect: { current: null }, canvasSize: { top: 0, left: 0, width: 100, height: 100 } };
