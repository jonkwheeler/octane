import { RenderCubeTexture, RenderTexture, type RenderCubeTextureApi, type RenderCubeTextureProps, type RenderTextureProps } from '@octanejs/drei';

const texture: RenderTextureProps = { children: null, width: 64, samples: 4, frames: 2 };
const cube: RenderCubeTextureProps = { children: null, resolution: 128, flip: true, near: 0.1, far: 100 };
