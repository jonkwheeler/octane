...
import { runPristineUpstreamSuite } from '../../../scripts/react-parity/react-pdf-pristine-runtime.mjs';
...
it('runs the pinned react-pdf 10.4.1 Vitest suite unchanged', function runsPinnedReactPdfSuite() {
	const expected = JSON.parse(
		readFileSync(resolve(repoRoot, 'packages/react-pdf/audit/pristine-runtime.json'), 'utf8'),
	).tests as Identity[];
