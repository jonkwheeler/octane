...
type PanelExcludesNativeResize = Assert<
	Not<'onResizeCapture' extends keyof PanelProps ? true : false>
>;
type SeparatorProtectsRole = Assert<Not<'role' extends keyof SeparatorProps ? true : false>>;
type SeparatorProtectsTabIndex = Assert<
	Not<'tabIndex' extends keyof SeparatorProps ? true : false>
>;
void (null as unknown as
	| HasNoMissingRuntimeExport
	| HasNoExtraRuntimeExport
	| GroupExcludesRef
	| PanelExcludesRef
	| PanelExcludesNativeResize
	| SeparatorProtectsRole
	| SeparatorProtectsTabIndex);
...
void [
	...
	invalidPanelRef,
	invalidResize,
	invalidSeparatorRole,
	invalidSeparatorTabIndex,
];
