...
const groupProps: GroupProps = { orientation: 'horizontal', defaultLayout: { left: 50, right: 50 } };
...
void [groupProps, panelProps, separatorProps, groupHandle, panelHandle, groupCallback, panelCallback, invalidGroup, invalidPanel];
