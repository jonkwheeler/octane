...
export type CSSProperties = Exclude<OctaneJSXRuntime.JSX.IntrinsicElements['div']['style'], string | undefined>;
...
> = NativeEvent<T, E>;
export type UIEvent<T extends Element = Element, E extends globalThis.UIEvent = globalThis.UIEvent> = NativeEvent<T, E>;
...
export type ButtonHTMLAttributes<T extends HTMLButtonElement = HTMLButtonElement> = HTMLAttributes<T> &
  Partial<{
    disabled: boolean;
    name: string;
