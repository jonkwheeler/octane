...
export function useReactFlow<NodeType extends Node = Node, EdgeType extends Edge = Edge>(
  ...
  const generalHelper = useMemo<GeneralHelpers<NodeType, EdgeType>>(function buildGeneralHelper() {
  ...
  return useMemo(function combineHelpers() {
    return {
      ...generalHelper,
      ...viewportHelper,
      viewportInitialized,
    };
  }, [viewportInitialized, generalHelper, viewportHelper], slot);
}
